...
export default function AuthPage() {
    ...
    return (
        <div className="flex min-h-screen">
            ...
            {/* RIGHT FORM */}
            <div className="flex w-full md:w-4/12 items-center justify-center bg-white ">
                <div className="w-full max-w-sm text-center">
                    ...
                    <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                        Trace is a
                        <span className="font-extrabold"> smart financial tracking app </span>
                        for building healthy financial habits. Track expenses, set budget limits,
                        and manage your cash flow easily and securely.
                    </p>
